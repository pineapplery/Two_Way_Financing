...
import sty from "./PlasmicNavigationBar.module.css"; // plasmic-import: UvvhO7GYaiHb/css
  ...
  return (
    <NavigationBar
      ...
      closeButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__ll0th)}
          displayHeight={"auto"}
      ...
      openButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__aK7Gr)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}
