...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: ul0ny5BBDXt2/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__j2BzQ)}>
        <div className={classNames(projectcss.all, sty.column__vWAeT)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__h4Y5N)}>
          <div className={classNames(projectcss.all, sty.columns__yf6Vg)}>
            <div className={classNames(projectcss.all, sty.column___9VkEg)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__q4Kpc)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__sCwAs)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___465NK)}>
                {renderPlasmicSlot({
